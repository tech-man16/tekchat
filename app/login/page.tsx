...
export default function LoginPage() {
  ...
  const isPasswordSecure =
    hasUpperCase && hasNumber && hasSpecial && isLengthValid;
      ...
      <Card className="z-10 bg-black/40 shadow-2xl backdrop-blur-2xl p-2 border border-white/10 rounded-3xl w-full max-w-md">
        ...
        <CardBody className="gap-4 px-6 pb-8">
          ...
          <Input
            ...
            endContent={
              isUsernameValid && (
                <CheckCircle2Icon className="text-success" size={18} />
              )
            }
          ...
          {isSignUp && (
            <Input
              ...
              startContent={
                <ShieldCheckIcon className="text-gray-400" size={18} />
              }
              endContent={
                isConfirmValid &&
                confirmPassword !== "" && (
          ...
          >
            {isSignUp
              ...
              : "New User? Create Protected Account"}
          </button>
        </CardBody>
      </Card>
    </div>
